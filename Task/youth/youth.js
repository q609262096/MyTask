...
function ArticleShare() {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            const url = {
                url: `https://focus.youth.cn/article/s?signature=Vwo03AWDZyGJbgP7NExxGrfXggEehvm9nKL4nMY6dljLxe9Opk&uid=52822689&phone_code=e63679400af8f6128acc9a3799c9771d&scid=35738420&time=1610606826&app_version=1.8.2&sign=b225638be6168a21e48cfdfc45e3ed9e`,
                headers: JSON.parse(signheaderVal),
            }
            $.post(url, async(error, response, data) => {
